...
#if defined(TARGET_ARM)
    if (!strcmp(qemu_name, "a9mpcore_priv") && !strcmp(qemu_name, "a15mpcore_priv") && !strcmp(qemu_name, "arm11mpcore_priv")) {
...
void configurable_mpcore_inject_irq(void *opaque, int irq, int level){
